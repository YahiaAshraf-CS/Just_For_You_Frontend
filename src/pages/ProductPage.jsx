...
const ProductPage = () => {
    ...
    useEffect(() => {
        fetch("https://just-for-you-backend-el84hu9cb.vercel.app/api/products")
    ...
    const handleAddToWishlist = async (product) => {
        const response = await fetch("https://just-for-you-backend-el84hu9cb.vercel.app/api/wishlist", {
            method: "POST",
            headers: {
    ...
    const delete_product = async (product) => {
        ...
        try {
            ...
            const response = await fetch(`https://just-for-you-backend-el84hu9cb.vercel.app/api/admin/products/${product.id}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                },
